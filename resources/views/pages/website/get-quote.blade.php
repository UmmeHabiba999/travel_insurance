                                    ...
                                    <div class="Plans_boxPlans">
                                        <center>
                                            ...
                                            <div class="description-link">
                                                <a href="{{ $platinumQuote->content_url}}"
                                ...
                                <div class="col-md-12">
                                    <div class="Plans_boxPlans">
                                        <center>
                                            ...
                                            <h5 class="eligible text-center"><strong>Schengen Eligible</strong></h5>
                                            <div class="description-link">
                                                <a href="{{ $silverQuote->content_url }}"
                                                    target="_blank" rel="noopener noreferrer">Coverage Description</a>
                                            </div>
                                            <button class="man-benift-btn">
                                                Main benefits
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="d-flex align-items-center justify-content-between border-0 px-4 py-4">
                <p></p>
                <h5 class="modal-title" id="exampleModalLabel">Improve Your Travel by adding these optional benefits</h5>
            ...
            <div class="modal-body">
                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="Plans_boxPlans">
                                            <center>
                                                ...
                                                <h5 class="eligible text-center"><strong>Schengen Eligible</strong></h5>
                                                <div class="description-link">
                                                    <a href="https://zaasatspcmdpranc1sto.blob.core.windows.net/uploaded-documents/c485c7b1_6749_4370_a2f9_3e783d2ac58c.pdf?sv=2022-11-02&amp;se=2025-07-02T02%3A20%3A13Z&amp;sr=b&amp;sp=r&amp;sig=njJqz7xdwpz7sxflg8Trd7Z9cRnKz2DWmWpXUhj6yO8%3D" target="_blank" rel="noopener noreferrer">Coverage Description</a>
                                                </div>
                                                <button class="man-benift-btn">Main benefits</button>
                                            </center>
                    ...
                    <div class="col-md-8">
                        <div id="platinumAddonDiv" class="d-flex align-items-center justify-content-between addon-div">
                            <div>
                                <h3>Rental Car Damage covers up to $50,000</h3>
                                <h5 id="rentalCarDamage">Price: $31.74{{ $platinumQuote->price_rental_car_damage }}</h5>
                            </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between py-4">
                        <p></p>
                        <p></p>
                        <h5 class="text-center mb-0">Total: $<span id="platinumTotalPrice">{{ $total_price ?? $platinumQuote->price_after_discount_incl_tax }}</span></h5>
...
<div class="modal fade" id="gold-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="goldAddonDiv" class="d-flex align-items-center justify-content-between addon-div">
                            <div>
                                <h3>Rental Car Damage covers up to $50,000</h3>
                                <h5 id="rentalCarDamage">Price: $31.74{{ $goldQuote->price_rental_car_damage }}</h5>
                            </div>
                            <img src="{{ asset('assets/images/add-icon.png') }}" width="60px" height="60px" alt="">
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between py-4">
                        <p></p>
                        <p></p>
                        <h5 class="text-center mb-0">Total: $<span id="goldTotalPrice">{{ $goldQuote->price_after_discount_incl_tax }}</span></h5>
        ...
        <!-- Modal -->
<div class="modal fade" id="silver-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="d-flex align-items-center justify-content-between border-0 px-4 py-4">
                <p></p>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="silverAddonDiv" class="d-flex align-items-center justify-content-between addon-div">
                            <div>
                                <h3>Rental Car Damage covers up to $50,000</h3>
                                <h5 id="rentalCarDamage">Price: $31.74{{ $silverQuote->price_rental_car_damage }}</h5>
                            </div>
                            <img src="{{ asset('assets/images/add-icon.png') }}" width="60px" height="60px" alt="">
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between py-4">
                        <p></p>
                        <p></p>
                        <h5 class="text-center mb-0">Total: $<span id="silverTotalPrice">{{ $silverQuote->price_after_discount_incl_tax }}</span></h5>
                        <a href="{{ url('/checkout?quote_name=' . $silverQuote->name) }}" class="btn continue-btn">CONTINUE</a>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    function handleAddonClick(addonId, totalPriceId, basePrice) {
        document.getElementById(addonId).addEventListener('click', function() {
            let addonDiv = this;
            let totalPriceElement = document.getElementById(totalPriceId);
            let rentalCarDamage = 31.74;

            // Toggle the 'active' class
            if (addonDiv.classList.contains('active')) {
                addonDiv.classList.remove('active');
                addonDiv.style.backgroundColor = '';
                totalPriceElement.textContent = basePrice.toFixed(2);
            } else {
                addonDiv.classList.add('active');
                addonDiv.style.backgroundColor = '#58b058';
                let totalPrice = basePrice + rentalCarDamage;
                totalPriceElement.textContent = totalPrice.toFixed(2);
            }
        });
    }

    handleAddonClick('platinumAddonDiv', 'platinumTotalPrice', parseFloat('{{ $platinumQuote->price_after_discount_incl_tax }}'));
    handleAddonClick('goldAddonDiv', 'goldTotalPrice', parseFloat('{{ $goldQuote->price_after_discount_incl_tax }}'));
    handleAddonClick('silverAddonDiv', 'silverTotalPrice', parseFloat('{{ $silverQuote->price_after_discount_incl_tax }}'));
});
